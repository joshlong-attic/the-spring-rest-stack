...
/**
 * In conjunction with {@link CrmWebApplicationInitializer}, this configuration
 * class sets up Spring Security and Spring Security OAuth.
 * 
...
public class CrmSecurityApplicationInitializer extends AbstractSecurityWebApplicationInitializer {
	...
	protected void afterSpringSecurityFilterChain(ServletContext servletContext) {
		insertFilters(servletContext, 
				new HiddenHttpMethodFilter(), new MultipartFilter(), new OpenEntityManagerInViewFilter());
	}
