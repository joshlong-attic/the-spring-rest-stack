...
#import "CRMAuthControllerDelegate.h"

@interface CRMSignInViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, CRMAuthControllerDelegate>
